...
import com.skillstorm.fincen_project2_backend.services.RoomTypeAmenityService;
...
public class RoomTypeAmenityController {
    ...
    public void deleteOne(@PathVariable UUID roomTypeId, @PathVariable UUID amenityId) {
