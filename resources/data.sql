-- =========================
-- IDs (hard-coded UUIDs so FKs line up)
-- =========================
...
-- Users
INSERT INTO users (user_id, first_name, last_name, email, phone, address1, city, state, zip, status)
VALUES
('33333333-3333-3333-3333-333333333333', 'Joshua', 'Thompson', 'joshua@example.com', '912-555-0101', '813 Stockdale Rd', 'Copperas Cove', 'TX', '76522', 'ACTIVE'),
('44444444-4444-4444-4444-444444444444', 'Hannah', 'Thorpe', 'hannah@example.com', '512-555-0102', '1 Admin Way', 'Austin', 'TX', '78701', 'ACTIVE'),
('55555555-5555-5555-5555-555555555555', 'Murali', 'Guthula', 'murali@example.com', '512-555-0103', '2 Manager Dr', 'Austin', 'TX', '78701', 'ACTIVE');
...
('a2a2a2a2-a2a2-a2a2-a2a2-a2a2a2a2a2a2', 'Breakfast Included', 'HOTEL', TRUE),
('a3a3a3a3-a3a3-a3a3-a3a3-a3a3a3a3a3a3', 'Pool Access', 'HOTEL', TRUE),
('a4a4a4a4-a4a4-a4a4-a4a4-a4a4a4a4a4a4', 'Kitchenette', 'ROOM', TRUE),
('a5a5a5a5-a5a5-a5a5-a5a5-a5a5a5a5a5a5', 'Accessible Shower', 'ACCESSIBILITY', TRUE);
...
-- A cancelled reservation example
INSERT INTO reservations (
  reservation_id, hotel_id, user_id, room_id, room_type_id,
...
('90000000-0000-0000-0000-000000000003', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333',
 ...
 'Plans changed', TIMESTAMP '2025-12-16 10:15:00', '33333333-3333-3333-3333-333333333333');

-- Reservation hold (simulate a checkout hold)
...
('91000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111',
 ...
 DATE '2025-12-21', DATE '2025-12-22', 'ACTIVE', TIMESTAMP '2025-12-16 12:45:00');
